...
var query6 = _.chain(nathanGameList).union(rossGameList).uniq().value();
...
var query8 = _.chain(rossGameList)
              .difference(nathanGameList)
              .union(
                _.chain(nathanGameList)
                 .difference(rossGameList)
                 .value()
              ).value();
